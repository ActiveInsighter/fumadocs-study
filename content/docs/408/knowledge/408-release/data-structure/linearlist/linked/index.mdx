...
**动态分配** 的空间存储在 **[进程的堆](https://csgraduates.com/operating_system/process/process_thread/#%e8%bf%9b%e7%a8%8b%e5%86%85%e5%ad%98%e7%a9%ba%e9%97%b4)** 中，这些 **结点** 占用的存储空间不是连续的，而是离散的，如下图所示：
...
数组（顺序表）与 **链表** 不同，由于数组一般是直接作为函数的局部变量使用 `int a[N]` 定义的，所以数组存储在 **[进程的栈](https://csgraduates.com/operating_system/process/process_thread/#%e8%bf%9b%e7%a8%8b%e5%86%85%e5%ad%98%e7%a9%ba%e9%97%b4)** 中，数组中的相邻元素是 **连续** 地存储在栈上，如下图所示：

<InlineSvg src="/images/data-structure/data-structure-linearlist-linked-003.svg" alt={"图示"} />

由于数组在内存中的存储是 **连续** 的，这有利于程序的 [**空间局部性**](https://csgraduates.com/constitution_principle/storage/cache/#%e7%a9%ba%e9%97%b4%e5%b1%80%e9%83%a8%e6%80%a7)，当访问一个元素时，相邻的元素也会被加载到 **CPU 缓存** 中，这提高了访问速度。  
...
选择题
[16#1](https://csgraduates.com/study_methods/408quiz/2016/#1)
[16#2](https://csgraduates.com/study_methods/408quiz/2016/#2)
[21#1](https://csgraduates.com/study_methods/408quiz/2021/#1)
[23#2](https://csgraduates.com/study_methods/408quiz/2023/#2)
[24#1](https://csgraduates.com/study_methods/408quiz/2024/#1)
[26#2](https://csgraduates.com/study_methods/408quiz/2026/#2)

解答题
[09#42](https://csgraduates.com/study_methods/408quiz/2009/#42)
[12#42](https://csgraduates.com/study_methods/408quiz/2012/#42)
[15#41](https://csgraduates.com/study_methods/408quiz/2015/#41)
[19#41](https://csgraduates.com/study_methods/408quiz/2019/#41)
