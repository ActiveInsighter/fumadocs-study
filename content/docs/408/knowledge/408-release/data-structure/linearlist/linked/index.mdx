...
![a 1 a 2 a n Linked List L header node NULL](/images/data-structure/data-structure-linearlist-linked-001.svg)
...
![data next](/images/data-structure/data-structure-linearlist-linked-002.svg)
...
![图示](/images/data-structure/data-structure-linearlist-linked-003.svg)
...
![图示](/images/data-structure/data-structure-linearlist-linked-004.svg)
...
![p q p q n p q n](/images/data-structure/data-structure-linearlist-linked-005.svg)
...
![p q p q p p→next ≠ NULL 时 p→next = q→next free(q);](/images/data-structure/data-structure-linearlist-linked-006.svg)
...
![^ a1 a2 a3 prev data next head DNode](/images/data-structure/data-structure-linearlist-linked-007.svg)
...
![2 b 5 a 1 d -1 c 3 0 1 2 3 4 5 6 静态链表示例 a b c d ^ 对应的单链表](/images/data-structure/data-structure-linearlist-linked-008.svg)
...
![a 1 a 2 a n head a 2 a 1 a 3 ^ head 循环单链表 循环双链表](/images/data-structure/data-structure-linearlist-linked-009.svg)
