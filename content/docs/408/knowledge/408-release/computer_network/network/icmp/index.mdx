---
title: "ICMP"
description: "💡 低优先级 在选择题中考查，频率不高，关注下差错报文的类型以及 icmp 的应用。 真题 2 选择题 10 36 12 33 ICMP （Internet Control Message Protocol）是一个 网络层协议 用于在 IP"
source: "https://csgraduates.com/computer_network/network/icmp/"
---
...
选择题
[10#36](/study_methods/408quiz/2010/#36)
[12#33](/study_methods/408quiz/2012/#33)
...
![ICMP 图 1](/images/computer-network/computer-network-network-icmp-001.svg)
...
![ICMP 图 2](/images/computer-network/computer-network-network-icmp-002.svg)
